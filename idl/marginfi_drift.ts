    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "driftOracle",
          "docs": [
            "The oracle account for the asset (not needed for USDC/market 0)"
          ],
          "optional": true
        },
        {
  ...
  "types": [
    ...
    },
    {
      ...
      "docs": [
        ...
        "",
        "TODO: Add operational state (for banks starting in paused state) and config flags for future-proofing.",
        "See PR #115 comment: https://github.com/mrgnlabs/marginfi-v2-internal/pull/115#discussion_r2250550192",
        "This pattern should probably also apply to Kamino and Drift config structs."
      ],
      "type": {
        "kind": "struct",
        "fields": [
