...
| Asset | Bank | Market Index | Oracle Type | Token Program |
|-------|------|--------------|-------------|---------------|
| USDC | `73PAdXZSH7s89QBLUHntp12QaHWqdc6GChCYLSVF1RBJ` | 0 | Pyth Push | SPL Token |
| SOL | `H2FT24RksVSq6kxhfPZacyqbEaXUtRZNi1QvMGV9RrFX` | 1 | Switchboard Pull | SPL Token |
| jitoSOL | `7TduwJSpq2zhPguaciA3GADsnspwSx6FQjZUhy37Jtgz` | 6 | Switchboard Pull | SPL Token |
