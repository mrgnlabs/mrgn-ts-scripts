...
const config: Config = {
  ...
  ORACLE: new PublicKey("CTn1eaLioKeZ53DyA5XRYVA9rWutxCfTzfvyezAPuSuC"),
...
const rate: InterestRateConfig1_7 = {
  ...
  points: [
    ...
    { util: utilToU32(0.8), rate: aprToU32(0.05) },
    { util: utilToU32(0.9), rate: aprToU32(0.25) },
    { util: utilToU32(0.95), rate: aprToU32(0.5) },
    { util: 0, rate: 0 },
    { util: 0, rate: 0 },
  ],
  curveType: 1,
...
const bankConfig: BankConfig = {
  ...
  borrowLimit: new BN(250_000 * 10 ** 6),
  riskTier: { collateral: {} },
  totalAssetValueInitLimit: new BN(750_000),
  oracleMaxAge: 300,
  assetTag: 0,
