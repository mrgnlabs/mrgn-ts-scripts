...
const config: Config = {
  ...
  ORACLE: new PublicKey("EcL93EQPJUgGehECHKhQ96cs6LWJXktzf7to92d9AjCT"),
  ORACLE_TYPE: ORACLE_TYPE_SWB,
  ADMIN: new PublicKey("CYXEgwbPHu2f9cY3mcUkinzDoDcsSan7myh1uBvYRbEw"),
  BANK_MINT: new PublicKey("GJ3CvAnawvxwReu7MhBfTQBLcfcs1awP5h55SzoBBNYq"),
  SEED: 0,
...
const rate: InterestRateConfig1_7 = {
  ...
  points: [
    { util: utilToU32(0.5), rate: aprToU32(0.05) },
    { util: utilToU32(0.8), rate: aprToU32(0.1) },
    { util: utilToU32(0.9), rate: aprToU32(0.4) },
    { util: 0, rate: 0 },
    { util: 0, rate: 0 },
    { util: 0, rate: 0 },
  ],
...
const bankConfig: BankConfig = {
  ...
  depositLimit: new BN(300_000 * 10 ** 6),
  interestRateConfig: rate,
  operationalState: { operational: {} },
  borrowLimit: new BN(100_000 * 10 ** 6),
  riskTier: { collateral: {} },
  totalAssetValueInitLimit: new BN(300_000),
  oracleMaxAge: 300,
  assetTag: 0,
