...
const config: Config = {
  ...
  ORACLE: new PublicKey("7MUWCEmm8HWa9WZJq5DutZm1B3ziTkLmaKQknAd2xu2m"),
  ORACLE_TYPE: ORACLE_TYPE_SWB,
  ADMIN: new PublicKey("CYXEgwbPHu2f9cY3mcUkinzDoDcsSan7myh1uBvYRbEw"),
  FEE_PAYER: new PublicKey("CYXEgwbPHu2f9cY3mcUkinzDoDcsSan7myh1uBvYRbEw"),
  BANK_MINT: new PublicKey("METvsvVRapdj9cFLzq4Tr43xK4tAjQfwX76z3n6mWQL"),
  SEED: 0,
...
const rate: InterestRateConfigRaw = {
  ...
  insuranceIrFee: bigNumberToWrappedI80F48(0.01),
...
const bankConfig: BankConfigRaw_v1_4 = {
  ...
  borrowLimit: new BN(1_500_000 * 10 ** 6),
  riskTier: { collateral: {} },
